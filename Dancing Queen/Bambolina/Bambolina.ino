...
const double motorSpeedFactorLeft = 0.69;
...
void loop()
{
  ...
  */
  ...
  analogWrite(A2, 255);    // Set A2 to low (0) for the third phase
  analogWrite(A0, 0);  // Set A3 to high (255) for the third phase
  mpu.resetFIFO();       // Reset FIFO
